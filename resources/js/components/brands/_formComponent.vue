    ...
    <div class="form">
        <div class="kt-portlet__body">
            <div class="row">
                <div v-for="(language, index) in languages" class="col-4 " :class="index">
                    <div :class="['form-group', allerros['brand_name_'+index] ? 'validated' : '']">
                        <label class="form-control-label">Название бренда ({{language}}) <span>*</span></label>
                        <input type="text"
                               :class="['form-control', allerros['brand_name_'+index] ? 'is-invalid' : '']"
                               v-model="form['brand_name_'+index]">
                        <div class="invalid-feedback" v-if="allerros['brand_name_'+index]"
                             :class="['label label-danger']">{{
                            allerros['brand_name_'+index][0] }}
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div v-if="form.brand_image" class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar">
                        <div class="kt-avatar__holder">
                            <img  :src="form.brand_image" alt="img">
                        </div>
                        <a v-if="form.brand_image" class="kt-avatar__upload" @click="removeImage()">
        ...
        <div class="kt-portlet__foot">
            ...
            <div class="kt-form__actions">
                ...
                <router-link to="/vagart-cms/brands" type="reset" class="btn btn-secondary">Отмена</router-link>
            </div>
        </div>
    </div>
</template>
            ...
            handleSelects(e) {
                ...
                fileList.forEach(f => {
                    ...
                    reader.onload = function (e) {
                        that.form.brand_image = e.target.result;
                    };
