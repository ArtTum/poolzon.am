        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Редактировать баннер </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <router-link to="/vagart-cms/banner-types" class="kt-subheader__breadcrumbs-home">Баннер
                        </router-link>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" class="form-horizontal" @submit.prevent="onSubmit"
                            ...
                            <banner-form :allerros="allerros" :form="form" :success="success"
                                         :id="id"></banner-form>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.commit('changeBannersGet', this.id);
            this.$store.dispatch('returnBannersGet');
        },
        computed: mapGetters([
            "allReturnBannersGet",
        ]),
        methods: {
            onSubmit() {
                ...
                this.formData.append('banner_url', this.form.banner_url);
                this.formData.append('banner_image', this.form.banner_image);
                this.formData.append('banner_image', this.form.image);
                const config = {
                    headers: {'content-type': 'multipart/form-data'}
                };

                Vue.axios.post('/banners-update', this.formData, config).then(response => {
                    this.allerros = [];
                    this.success = true;
                    if (this.success) {
        ...
        watch: {
            ...
            allReturnBannersGet: function (val) {
                this.form.banner_url = val.bannerForm.banner_url;
                this.form.banner_image = val.bannerForm.banner_image ?  '/uploads/banners/' + val.bannerForm.banner_image : '';
            }
        },
    }
</script>
