    ...
    <div class="form">
        <div class="kt-portlet__body">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group" >
                        <div  :class="['form-group', allerros['colors'] ? 'validated' : '']">
                            <v-multiselect-listbox  v-if="(form.colors) && (params.colors && params.colors.length)" v-model="form.colors"  :options="params.colors"
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div :class="['form-group', allerros['product_count'] ? 'validated' : '']">
                        <label class="form-control-label">Product Count </label>
                        <input type="text" :class="['form-control', allerros['product_count'] ? 'is-invalid' : '']"
                               v-model="form['product_count']">
                        <div class="invalid-feedback" v-if="allerros['product_count']" :class="['label label-danger']">{{
                            allerros['product_count'][0] }}
                        </div>
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                <div class="col-4">
                    <div :class="['form-group', allerros['number_mounting_holes'] ? 'validated' : '']">
                        <label class="form-control-label">Число монтажных отверстий </label>
