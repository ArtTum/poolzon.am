        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Редактировать цвет</h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <router-link to="/colors" class="kt-subheader__breadcrumbs-home">Цвета</router-link>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" class="form-horizontal" @submit.prevent="onSubmit"
                            ...
                            <colors-form :allerros="allerros" :form="form" :success="success" :languages="languages"
                                        :id="id"></colors-form>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.commit('changeColorId', this.id);
            this.$store.dispatch('returnColorEditGet');
        },
        computed: mapGetters([
            "returnColorGet",
        ]),
        ...
        watch: {
            returnColorGet: function (val) {
                let arm = 0;
                let ru = 1;

                this.form.color_name_am = val.colorForm.lang[arm].color_name;
                this.form.color_name_ru = val.colorForm.lang[ru].color_name;
            }
        }
    }
</script>
