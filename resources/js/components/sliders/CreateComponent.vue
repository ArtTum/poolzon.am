        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Добавить новый слайдер</h3>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" action="/slider-store"  class="form-horizontal" @submit.prevent="onSubmit"  enctype="multipart/form-data">
                            <slider-form :allerros="allerros" :form="form" :success="success" :languages="languages"></slider-form>
                        </form>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods : {
            onSubmit() {
                ...
                Vue.axios.post('/sliders-store', this.formData, config).then( response => {
                    this.allerros = [];
                    this.success = true;
                    if (this.success){
