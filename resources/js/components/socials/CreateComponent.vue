        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Добавить новый соцсеть</h3>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" action="/social-store"  class="form-horizontal" @submit.prevent="onSubmit"  enctype="multipart/form-data">
                            <socials-form :allerros="allerros" :form="form" :success="success"></socials-form>
                        </form>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods : {
            onSubmit() {
                ...
                Vue.axios.post('/socials-store', this.formData, config).then( response => {
                    this.allerros = [];
                    this.success = true;
                    if (this.success){
