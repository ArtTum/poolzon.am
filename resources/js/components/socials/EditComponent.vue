        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Редактировать соцсеть </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <router-link to="/vagart-cms/social-types" class="kt-subheader__breadcrumbs-home">Соцсети
                        </router-link>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" class="form-horizontal" @submit.prevent="onSubmit"
                            ...
                            <socials-form :allerros="allerros" :form="form" :success="success" :languages="languages"
                                         :id="id"></socials-form>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.commit('changeSocialsGet', this.id);
            this.$store.dispatch('returnSocialsGet');
        },
        computed: mapGetters([
            "allReturnSocialsGet",
        ]),
        methods: {
            onSubmit() {
                ...
                this.formData.append('icon_url', this.form.icon_url);
                this.formData.append('icon_image', this.form.icon_image);
                this.formData.append('icon_image', this.form.image);
                const config = {
                    headers: {'content-type': 'multipart/form-data'}
                };

                Vue.axios.post('/socials-update', this.formData, config).then(response => {
                    this.allerros = [];
                    this.success = true;
                    if (this.success) {
        ...
        watch: {
            ...
            allReturnSocialsGet: function (val) {
                this.form.name = val.socialForm.name;
                this.form.icon_url = val.socialForm.url;
                this.form.icon_image = val.socialForm.icon ?  '/uploads/socials/' + val.socialForm.icon : '';
            }
        },
    }
</script>
