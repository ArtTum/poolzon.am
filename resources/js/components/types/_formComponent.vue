    ...
    <div class="form">
        <div class="kt-portlet__body">
            <div class="row">
                <div v-for="(language, index) in languages" class="col-4 " :class="index">
                    <div :class="['form-group', allerros['type_name_'+index] ? 'validated' : '']">
                        <label class="form-control-label">Название типа ({{language}}) <span>*</span></label>
                        <input type="text" :class="['form-control', allerros['type_name_'+index] ? 'is-invalid' : '']"
                               v-model="form['type_name_'+index]">
                        <div class="invalid-feedback" v-if="allerros['type_name_'+index]" :class="['label label-danger']">{{
                            allerros['type_name_'+index][0] }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="kt-portlet__foot">
            ...
            <div class="kt-form__actions">
                ...
                <router-link to="/vagart-cms/types" type="reset" class="btn btn-secondary">Отмена</router-link>
            </div>
        </div>
    </div>
</template>
