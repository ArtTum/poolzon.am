        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Добавить новый тип  </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <router-link to="/vagart-cms/types" class="kt-subheader__breadcrumbs-home">Типы</router-link>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <form method="POST" action="/types-store"  class="form-horizontal" @submit.prevent="onSubmit"  enctype="multipart/form-data">
                            <types-form :allerros="allerros" :form="form" :success="success" :languages="languages"></types-form>
                        </form>
                    </div>
                </div>
            </div>
