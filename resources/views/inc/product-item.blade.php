<div class="product-item">
    ...
    <div class="product-item__info">
        ...
        <p class="product-item__type font-primary--medium margin-bottom-small-xs">{{ __('messages.Бестселлер') }}</p>
        <p class="product-item__title">
            <a href="index.php?page=product-view"><span class="font-primary--medium display--block">
                    Люк полимерный квадратный</span><span>серый 685x685x60</span>
            </a>
        </p>
