...
//            'email.email' => 'that is not an email address'
    ...
    {
        return [
            'resource_name' =>  __('messages.Название ресурса'),
            'resource_url' => __('messages.Ссылка'),
            'category_id' => __('messages.Категория'),
            'resource_desc' => __('messages.Описание сайта (на любом языке)'),
